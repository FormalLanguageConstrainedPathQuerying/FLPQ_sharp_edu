...
88. Fix nonterminals rendering in TeX. Do not replace names to N_i by regexps in several places, update to CNF conversion to generate uniquie nonterminals with respective names.
