...
261. For RNGLR visualization, for each step track GSS vertices where passing reductions handling triggers. Highlight these vertices with new color. Add this color to summary legend together with other colors. Share color with one used for GLL stored pops.