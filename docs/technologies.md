* [Argu](https://fsprojects.github.io/Argu/) for CLI.
* [FSharpPlus](https://fsprojects.github.io/FSharpPlus/) for NonEmptyList and NonEmptySet types.
* [FsCheck](https://fscheck.github.io/FsCheck/) for property-based testing.
